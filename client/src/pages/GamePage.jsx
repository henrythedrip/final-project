  ...
  function chooseCategory(category) {
    ...
    const scoreRender = () => {
      return (
        <div>
          <h2>
            Number of Questions: {scoreSubmit.questionCount} Correct Questions:{" "}
            {scoreSubmit.correct}
          </h2>
        </div>
      );
    ...
    return (
      <div>
        ...
        <div className="true-false-responses">
          <button value="true" className="true-button" onClick={clickHandler}>
            True
          </button>
          <button value="false" className="false-button" onClick={clickHandler}>
            False
          </button>
        </div>
      </div>
